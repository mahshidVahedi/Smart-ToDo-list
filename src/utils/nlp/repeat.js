export function extractRepeat(text) {
  ...
  const isOneTime = /\b(شنبه|یکشنبه|دوشنبه|سه‌شنبه|چهارشنبه|پنج‌شنبه|پنجشنبه|جمعه)(‌?ها)?\b.*\b(هفته\s*(آینده|بعد))\b/.test(normalized);
  ...
  if (/(شنبه|یکشنبه|دوشنبه|سه‌شنبه|چهارشنبه|پنج‌شنبه|پنجشنبه|جمعه)(‌?ها)/.test(normalized)) {
    return 'weekly';
  }
